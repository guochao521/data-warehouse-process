...
import org.mallmark.litemall.core.express.ExpressService;
import org.mallmark.litemall.core.express.dao.ExpressInfo;
import org.mallmark.litemall.core.notify.NotifyService;
import org.mallmark.litemall.core.notify.NotifyType;
import org.mallmark.litemall.core.qcode.QCodeService;
import org.mallmark.litemall.core.system.SystemConfig;
import org.mallmark.litemall.core.task.TaskService;
import org.mallmark.litemall.core.util.DateTimeUtil;
import org.mallmark.litemall.core.util.IpUtil;
import org.mallmark.litemall.core.util.JacksonUtil;
...
import org.mallmark.litemall.db.util.CouponUserConstant;
import org.mallmark.litemall.db.util.GrouponConstant;
import org.mallmark.litemall.db.util.OrderHandleOption;
import org.mallmark.litemall.db.util.OrderUtil;
import org.mallmark.litemall.wx.dto.OrderCommentPost;
import org.mallmark.litemall.wx.task.OrderUnpaidTask;
import org.mallmark.litemall.wx.vo.OrderCommentVo;
import org.mallmark.litemall.wx.vo.VantUploaderVo;
...
import static org.mallmark.litemall.wx.util.WxResponseCode.*;
...
public class WxOrderService {
     ...
     * @return
     */
    public Object simulatePay(Integer userId, String body) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
        Integer orderId = JacksonUtil.parseInteger(body, "orderId");
