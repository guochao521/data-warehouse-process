...
import org.simulate.dw.bean.events.*;
import org.simulate.dw.rest.UserAction;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;
import org.simulate.dw.bean.AppBase;
import org.simulate.dw.bean.AppStart;
import org.simulate.dw.bean.events.*;
...
//                    System.out.println(jsonStr);
    ...
    private void sendStartLog(AppStart appStart) {
     ...
     //   RequestBody body = RequestBody.create(okhttp3.MediaType.parse("text/plain; charset=utf-8"), jsonString);
