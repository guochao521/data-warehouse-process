...
public class LitemallOrderDetailCap {
    private int   id               ;
    ...
    private double capitation_price = 0;
    ...
    public double getCapitation_price() {
        return capitation_price;
    }

    public void setCapitation_price(double capitation_price) {
        this.capitation_price = capitation_price;
    }
}
